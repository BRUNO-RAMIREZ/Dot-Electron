...
export const defaultTenant = 'ysit';
...
export const wallConfig: WallConfig = {
  items: [
    {
      component: CmtMessageWallComponent,
      facade: DtCommentsGetDataFacade,
      notification: CmtNotificationWallComponent,
      serviceName: 'social-comments'
    }
  ]
};
